  ...
  return (
    <main className="min-h-screen p-8 bg-background text-foreground">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 bg-primary-teal rounded-3xl shadow-xl border border-text-dark">
            ...
            <a
              href="#"
              className="text-primary-teal hover:underline font-bold"
            >
              อ่านเพิ่มเติม
            </a>
          </div>
      ...
      <section className="mb-8">
        ...
        <div className="overflow-x-auto rounded-3xl shadow-xl border border-primary-teal">
          <table className="min-w-full divide-y divide-primary-teal">
            <thead className="bg-text-dark">
              ...
              <tr>
                <th
                  scope="col"
                  className="px-6 py-4 text-left text-xs font-kanit font-medium text-white uppercase tracking-wider"
                >
                  รายการ
                </th>
                <th
